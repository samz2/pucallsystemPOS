 ...
 */
function num_to_letras($numero, $moneda = 'SOLES', $subfijo = 'Y')
{
    $xarray = array(
        0 => 'Cero'
    ...
    for ($xz = 0; $xz < 3; $xz++) {
        ...
        if ('' != trim($xaux)) {
            switch ($xz) {
                ...
                case 2:
                    if (1 > $numero) {
                        $xcadena = "CERO {$subfijo} {$xdecimales}/100 {$moneda}";
                    }
                    if ($numero >= 1 && $numero < 2) {
                        $xcadena = "UN {$subfijo} {$xdecimales}/100 {$moneda}";
                    }
                    if ($numero >= 2) {
                        $xcadena.= "{$subfijo} {$xdecimales}/100 {$moneda}"; //
                    }
                    break;
            } // endswitch ($xz)
        } // ENDIF (trim($xaux) != "")
