...
class Transportepublico_model extends CI_Model {
  ...
  public function update($where, $data, $tabla) {
    ...
    public function serchDuplicado($documento, $id){
        $this->db->where("tipodocumento", "R.U.C");
        $this->db->where("documento", $documento);
        $id ? $this->db->where("id <>", $id) : "";
        return $this->db->get("transportepublico")->row();
    }
